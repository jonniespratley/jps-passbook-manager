...
module.exports = function(async, assert, _, path, glob, fs, Logger, Utils) {
	...
	function SignPass(opts) {
		...
		let logger = Logger.getLogger('SignPass:' + path.basename(options.passFilename));
