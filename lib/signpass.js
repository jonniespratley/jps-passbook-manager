...
*/
SignPass.createPems = function(passTypeIdentifier, p12, pass, callback) {
	let _out = [],
		cmd1 = {},
		cmd2 = {},
		_p12,
	...
	passTypeIdentifier = passTypeIdentifier.replace(/\W/g, '-');
	...
	function _copyP12(cb) {
		_p12 = path.resolve(__dirname, '../data/certs/', passTypeIdentifier + '-' + path.basename(p12));
		fs.removeSync(_p12);
