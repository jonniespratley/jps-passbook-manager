...
module.exports = function(program) {
	...
	function savePassTypeIdentifier(obj, cb) {
		...
		obj.wwdr = path.resolve(__dirname, '../certificate/wwdr-authority.pem');
