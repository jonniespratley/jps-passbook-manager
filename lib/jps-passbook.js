...
module.exports = function jpsPassbook(program) {
	...
	return {
		...
		createPass: createPass,
		/**
		 * Batch perform an action
		 * @param action The type of action (create, sign, validate)
		 * @param passes
		 * @returns {*}
		 */
		batchPromise: function (action, passes) {
			...
			return new Promise(function (resolve, reject) {
				...
				_.forEach(passes, function (_pass) {
					...
					switch (action) {
						case 'create':
							_promises.push(self.createPassPromise(_pass));
							_done();
							...
							break;
						case 'sign':
							_promises.push(self.signPassPromise(_pass));
							_done();
							...
							break;
						case 'validate':
							_promises.push(self.validatePassPromise(_pass));
							_done();
