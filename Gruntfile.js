...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		watch : {
			...
			livereload : {
				files : ['<%= yeoman.app %>/{,*/}*.html', '<%= yeoman.app %>/views/{,*/}*.html', '{.tmp,<%= yeoman.app %>}/styles/{,*/}*.css', '{.tmp,<%= yeoman.app %>}/scripts/{,**/}*.js', '<%= yeoman.app %>/images/{,*/}*.{png,jpg,jpeg}'],
				tasks : ['livereload']
			}
		},
		connect : {
		...
		jshint : {
			...
			all : ['Gruntfile.js', '<%= yeoman.app %>/scripts/{,*/}*.js', '!<%= yeoman.app %>/scripts/vendor/{,*/}*.js']
		},
		testacular : {
			unit : {
		...
		copy : {
			dist : {
				files : [{
					...
					cwd : '<%= yeoman.app %>',
					dest : '<%= yeoman.dist %>',
					src : ['*.{ico,txt}', '.htaccess', 'bower_components/**/*']
				}]
			}
		},
		nodeunit : {
	...
	//  'coffee',
	//'compass:dist',
	'useminPrepare', 'imagemin', 'cssmin', 'htmlmin', 'concat', 'copy', 'cdnify', 'usemin', 'ngmin', 'uglify']);
