...
jpsPassbookManagerApp.controller('ManageCtrl', function($scope, $rootScope, $http, $document, $compile, $route, $routeParams, $location) {
	...
	$rootScope.SmartPass = {
		...
		getPasses : function() {
			...
			$http.jsonp('http://myappmatrix.com:8080/api/v2/myappmatrix/passes', options).success(function(data) {
